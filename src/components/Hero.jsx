    ...
    <a href={getVideoUrl(video)} target="_blank" rel="noopener noreferrer" className="video-card" style={{ textDecoration: 'none', color: 'inherit' }}>
        ...
        <div className="video-info">
            ...
            <div className="video-stats">
                <div className="stat-item"><Eye size={14} /> {video.views}</div>
                <div className="stat-item">{video.platform === 'youtube' ? <Heart size={14} /> : <MessageCircle size={14} />} {video.engagement}</div>
            </div>
        </div>
    </a>
)
                        ...
                        <div className="bitunix-layout">
                            ...
                            <div className="bitunix-info-grid">
                                <div className="bitunix-info-card">
                                    <div className="bitunix-info-icon"><span className="icon-container primary"><TrendingUp size={22} /></span></div>
                                ...
                                <div className="bitunix-info-card">
                                    <div className="bitunix-info-icon"><span className="icon-container primary"><Users size={22} /></span></div>
                                ...
                                <div className="bitunix-info-card">
                                    <div className="bitunix-info-icon"><span className="icon-container secondary"><Lock size={22} /></span></div>
                                ...
                                <div className="bitunix-info-card bitunix-contest-card">
                                    <div className="bitunix-info-icon"><span className="icon-container accent"><Trophy size={22} /></span></div>
