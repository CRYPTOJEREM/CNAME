...
const Learning = ({ setActiveTab }) => {
    ...
    const tradingModules = [
        {
            icon: <span className="icon-container blue"><BarChart3 size={22} /></span>, title: "Module 1 : Les Bases de l'Analyse Technique",
            videos: [
        ...
        {
            icon: <span className="icon-container teal"><TrendingUp size={22} /></span>, title: "Module 2 : Indicateurs Techniques Avancés",
            videos: [
        ...
        {
            icon: <span className="icon-container orange"><Target size={22} /></span>, title: "Module 3 : Stratégies de Trading",
            videos: [
    ...
    const defiModules = [
        {
            icon: <span className="icon-container purple"><Globe size={22} /></span>, title: "Module 1 : Introduction à la DeFi",
            videos: [
        ...
        {
            icon: <span className="icon-container gold"><Gem size={22} /></span>, title: "Module 2 : Staking et Yield Farming",
            videos: [
        ...
        {
            icon: <span className="icon-container indigo"><Lock size={22} /></span>, title: "Module 3 : Protocoles DeFi Avancés",
            videos: [
    ...
    const psychoModules = [
        {
            icon: <span className="icon-container orange"><Brain size={22} /></span>, title: "Module 1 : Psychologie du Trader",
            videos: [
        ...
        {
            icon: <span className="icon-container red"><Flame size={22} /></span>, title: "Module 2 : Mindset Gagnant",
            videos: [
        ...
        {
            icon: <span className="icon-container green"><Zap size={22} /></span>, title: "Module 3 : Gestion du Capital",
            videos: [
    ...
    return (
        <section className="learning-section">
            <div className="learning-header">
                <div className="learning-badge"><span className="icon-container sm indigo"><GraduationCap size={18} /></span> FORMATION COMPLÈTE</div>
            ...
            <div className="category-selector">
                <h3 className="category-title"><span className="icon-container sm orange"><Target size={16} /></span> Choisissez Votre Parcours</h3>
                <div className="category-buttons">
                    <button className={`category-btn ${category === 'trading' ? 'active' : ''}`} onClick={() => setCategory('trading')}>
                        <span className="cat-icon"><span className="icon-container lg blue"><BarChart3 size={26} /></span></span>
                    ...
                    <button className={`category-btn ${category === 'defi' ? 'active' : ''}`} onClick={() => setCategory('defi')}>
                        <span className="cat-icon"><span className="icon-container lg purple"><Globe size={26} /></span></span>
                    ...
                    <button className={`category-btn ${category === 'psycho' ? 'active' : ''}`} onClick={() => setCategory('psycho')}>
                        <span className="cat-icon"><span className="icon-container lg orange"><Brain size={26} /></span></span>
