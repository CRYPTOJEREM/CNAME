                            ...
                            <tbody>
                                {participants.map(user => (
                                    <tr key={user.id}>
                                        ...
                                        <td>
                                            <span className="status-badge" style={{ color: user.subscriptionStatus === 'vip' ? '#0A84FF' : user.subscriptionStatus === 'premium' ? '#FFD60A' : '#888' }}>
                        ...
                        <tbody>
                            {winners.map(w => (
                                <tr key={w.id}>
                                    ...
                                    <td>{w.userEmail}</td>
                                    <td>{w.bitunixUid}</td>
                                    <td style={{ color: '#0A84FF', fontWeight: 'bold' }}>${w.prize}</td>
                                    <td>
                                        {w.notified ? (
