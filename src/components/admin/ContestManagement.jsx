                            ...
                            <tbody>
                                {participants.map(user => (
                                    <tr key={user.id}>
                                        ...
                                        <td>
                                            <span className="status-badge" style={{ color: user.subscriptionStatus === 'vip' ? 'var(--accent-blue)' : user.subscriptionStatus === 'premium' ? 'var(--accent-gold)' : 'var(--text-tertiary)' }}>
                        ...
                        <tbody>
                            {winners.map(w => (
                                <tr key={w.id}>
                                    ...
                                    <td>{w.userEmail}</td>
                                    <td>{w.bitunixUid}</td>
                                    <td style={{ color: 'var(--accent-blue)', fontWeight: 'bold' }}>${w.prize}</td>
                                    <td>
                                        {w.notified ? (
